...
import br.ufscar.dc.dsw.controller.EmpresasUserController;
...
public class EmailService {
	...
	public void send(InternetAddress from, InternetAddress to, String subject, String body, File file) {
		...
		try {
			...
			InputStream is = EmpresasUserController.class.getClassLoader().getResourceAsStream("config.properties");
