...
<table border="1">
	...
	<c:if test="${profissional != null}">
		<input type="hidden" name="id"
			value="<c:out value='${profissional.id}' />" />
	</c:if>
	<tr>
	...
	<tr>
		<td><label for="nome"><fmt:message
					key="profissional.nome" /> </label></td>
		<td><input type="text" name="nome" size="45" required
			value="<c:out value='${profissional.nome}' />" /></td>
	</tr>

	<tr>
		<td><label for="senha"><fmt:message
					key="profissional.senha" /> </label></td>
