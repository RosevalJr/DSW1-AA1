...
<meta name="viewport" content="width=device-width, initial-scale=1.0">
	...
	<body>
		...
		<div align="center">
			...
			<h2>
				<a href="/<%=contextPath%>/admins/empresas"> <fmt:message
						key="empresa.entidade" />
				</a> &nbsp;&nbsp;&nbsp; <a
					href="${pageContext.request.contextPath}/logout.jsp"> <fmt:message
						key="sair.link" />
				</a> <br /> <br /> <a
					href="/<%=contextPath%>/admins/profissionais/cadastro"> <fmt:message
						key="profissional.criar" />
				</a>
			</h2>
			<h3>
		...
		<div align="center">
			<table border="1">
				...
				<c:forEach var="profissional"
					items="${requestScope.listaProfissionais}">
					<tr>
