	...
	<body>
		...
		<div align="center">
			<h1>
				...
				<c:out value="${profissional.nome}" />
			</h1>
			<h2>
				<a href="${pageContext.request.contextPath}/logout.jsp"> <fmt:message
						key="sair.link" />
				</a> <br /> <br /> <a href="#" onclick="history.go(-1)"> <fmt:message
						key="voltar" />
				</a>
			</h2>
			<br />
		...
		<div align="center">
			<h2>
				<fmt:message key="profissional.info" />
			</h2>
			<table border="1">
				<tr>
			...
			<form action="avaliaCandidatura" method="post">
				<input type="hidden" name="idVaga"
					value="<c:out value='${candidatura.idvaga}' />" /> <input
					type="hidden" name="idProfissional"
					value="<c:out value='${candidatura.idpessoa}' />" />
				<table border=1>
					<tr>
						<td><label for="link"><fmt:message
									key="link.conferencia" /> </label></td>
						<td><input type="text" name="link" size="45"></td>
					</tr>
					<tr>
						<td colspan="2" align="center"><input type="submit"
							name="entrevista" value="<fmt:message key="entrevista" />" /></td>
						<td colspan="2" align="center"><input type="submit"
							name="naoSelecionado"
